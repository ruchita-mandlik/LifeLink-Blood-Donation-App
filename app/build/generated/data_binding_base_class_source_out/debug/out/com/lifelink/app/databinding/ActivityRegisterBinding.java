...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull TextInputLayout tilPhone, @NonNull TextView tvGoToLogin, @NonNull TextView tvTitle) {
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((NestedScrollView) rootView, btnRegister,
          etConfirmPassword, etEmail, etName, etPassword, etPhone, ivBack, progressBar,
          tilConfirmPassword, tilEmail, tilName, tilPassword, tilPhone, tvGoToLogin, tvTitle);
    }
